...
int[] testArray1 = {1,0,1,1,0,1};

string str1 = string.Join("", testArray1);

Console.WriteLine($"исходный массив: {str1}, максимальное количество единиц подряд: {Calc1OneByOne(testArray1)}");

int[] testArray2 = {1,0,1,0,0,0,1};

string str2 = string.Join("", testArray2);

Console.WriteLine($"исходный массив: {str2}, максимальное количество единиц подряд: {Calc1OneByOne(testArray2)}");
